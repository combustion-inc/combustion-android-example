...
import inc.combustion.engineering.ui.camera.CameraScreen
import inc.combustion.engineering.ui.charts.ChartsScreen
import inc.combustion.engineering.ui.devices.DevicesScreen
import inc.combustion.engineering.ui.settings.SettingsScreen
import inc.combustion.engineering.ui.share.ShareScreen
            ...
            for (screen in bottomNavigationScreens) {
                composable(screen.route) {
                    when (screen) {
                        ...
                        is AppScreen.Camera -> CameraScreen(appState)
